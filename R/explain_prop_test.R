...
#'
#' @details This function attempts to communicate the results of a proportion test in a clear manner.
#'
#' @examples
#' \dontrun{
#' ptest <- prop.test(n_success, n_trials)
#' explain_prop_test(ptest)
#'}
#'
#' @export
